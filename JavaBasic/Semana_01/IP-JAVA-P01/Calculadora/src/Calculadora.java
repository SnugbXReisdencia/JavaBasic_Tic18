...
public class Calculadora {
	...
	public <T extends Number> T Dividir(T a, T b) {
		if (b.doubleValue() == 0) {
			...
			if (a instanceof Float || b instanceof Float) {
				...
				System.out.println("Você deve informar um tipo de dados numérico");
				return null;
			}
		}
	}
	...
	public ArrayList<Number> Subtrair(ArrayList<Number> a, ArrayList<Number> b) {
		ArrayList<Number> result = new ArrayList<>();
		if (a.size() == b.size()) {
			if (a instanceof ArrayList<?> && b instanceof ArrayList<?>) {
				Iterator<Number> iterA = a.iterator();
	...
	public ArrayList<Number> Multiplicar(ArrayList<Number> a, ArrayList<Number> b) {
		ArrayList<Number> result = new ArrayList<>();
		if (a.size() == b.size()) {
			if (a instanceof ArrayList<?> && b instanceof ArrayList<?>) {
				Iterator<Number> iterA = a.iterator();
	...
	public ArrayList<Number> Modulo(ArrayList<Number> a, ArrayList<Number> b) {
		if (a.size() != b.size()) {
			throw new ArraySizeDiferentesException(a, b);
		}
